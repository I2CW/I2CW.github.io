...
$(document).ready(function() {
		...
		for (i = 1; i < 118; i++) { 
				...
				switch (i) { 
					...
					case 3:
					case 4:
					$("#content").append("<div class='day' id='day" + i + "'>" + i + " <br><strong>" + newDateFormat + "</strong></div><div data='" + newDateFormat  + "' id='info" + i + "' class='inform'>Welcome to <br />Introduction to College Writing<br><br><a class='myButton' onClick=\"popUpApp('syllabus');\">Click to read syllabus</a>");
					break;
					case 57:
