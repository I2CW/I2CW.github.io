...
$(document).ready(function() {
		...
		for (i = 1; i < 118; i++) { 
				...
				switch (i) { 
					...
					case 3:
					case 4:
					$("#content").append("<div class='day' id='day" + i + "'>" + i + " <br><strong>" + newDateFormat + "</strong></div><div data='" + newDateFormat  + "' id='info" + i + "' class='inform'>Welcome to <br />Introduction to College Writing<br><br><a class='myButton' onClick=\"popUpApp('syllabus');\">Click to read syllabus</a><br><a class='myButton' href='https://blackhawk.blackboard.com/webapps/assessment/take/launchAssessment.jsp?course_id=_56259_1&content_id=_1212455_1&mode=cpview'>Precourse Assessment</a><br><a class='myButton' href='https://blackhawk.blackboard.com/webapps/assessment/take/launchAssessment.jsp?course_id=_56259_1&content_id=_1220870_1&mode=cpview'>Student Survey</a><br><p>All assignments or assessments listed are due by the end of class.");
					break;
					case 57:
